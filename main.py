...
# area2=[(120,540),(90,570),(260,610),(290,570)]
...
#        print(row)
    ...
    for bbox in bbox_id :
        ...
        ##people down
        results2 = cv2.pointPolygonTest(np.array(area1,np.int32),(((x4+x3)//2,y4)),False) #chấm tròn vào trong khu vực hai thì reutrn 1.0
        if results2 >= 0 :
